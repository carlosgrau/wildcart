...
public class FacturaDao extends GenericDaoImplementation implements DaoInterface {
    ...
    public FacturaDao(Connection oConnection, String ob,HttpServletRequest oRequest) {
    ...
    public ArrayList<FacturaBean> getpageXusuario(int iRpp, int iPage, int idUsuario, Integer expand, UsuarioBean usuarioSession,HttpServletRequest oRequest) throws Exception {
        ...
        if (iRpp > 0 && iRpp < 100000 && iPage > 0 && iPage < 100000000) {
            ...
            try {
                ...
                while (oResultSet.next()) {
                    ...
                    oFacturaBean.fill(oResultSet, oConnection, expand,oRequest);
